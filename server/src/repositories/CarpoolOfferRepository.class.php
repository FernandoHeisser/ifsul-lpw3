    ...
    class CarpoolOfferRepository {
        ...
        public function createCarpoolOffer($carpoolOfferArray) {
            try {
                ...
                $query = "INSERT INTO {$this->tableName} (user_id, phone, from_city, from_neighborhood, from_street, to_city, to_neighborhood, to_street, start_date, end_date, available_vacancies, canceled)
                    VALUES ( 
